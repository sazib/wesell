...
from shop.models import Category, DeliveryArea, Product
...
class Command(BaseCommand):
    help = "Seed the bakery store with sample categories, products, offers and a demo admin."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "Seed complete. Run 'python manage.py runserver' — admin/admin12345 for the admin panel."
            )
        )